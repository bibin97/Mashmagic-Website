      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <motion.div 
            ...
            viewport={{ once: true, margin: "-50px" }}
            transition={{ duration: 0.7, ease: "easeOut" }}
            className="lg:col-span-5 bg-[#0F172A] text-white rounded-[2.5rem] p-8 sm:p-10 shadow-2xl relative overflow-hidden group"
          >
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#008080]/20 rounded-full blur-3xl -mr-20 -mt-20 pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#f8ba2b]/10 rounded-full blur-3xl -ml-20 -mb-20 pointer-events-none" />

            <h3 className="text-2xl sm:text-3xl font-bold font-heading mb-6 relative z-10">
            ...
            <div className="space-y-8 relative z-10 mb-12">
              ...
              <div className="flex items-start gap-5 p-4 rounded-2xl bg-white/5 border border-white/10">
                ...
                <div>
                  <div className="text-xs text-slate-400 uppercase tracking-wider">Head Office</div>
